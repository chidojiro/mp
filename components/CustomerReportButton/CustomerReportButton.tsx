...
export const CustomerReportButton = ({
  ...
  <div className="border border-gray-500 border-solid rounded-md h-[60px] flex items-center justify-between text-gray-800 cursor-pointer" {...props}>
    ...
    <div className="flex items-center">
      ...
      <div className="mr-3"><ChevronRightIcon className="-mr-1 ml-2 h-5 w-5 bg text-secondary" aria-hidden="true" /></div>
    </div>
  </div>
);