  ...
  const listMenu: SideMenuItem[] = [
    {
      value: '1',
      label: (
        <Link href={{ pathname, query: { ...query, marketingActionId: '1' } }}>カゴ落ち通知</Link>
      ),
    ...
    },
    {
      value: '2',
      label: (
        <Link href={{ pathname, query: { ...query, marketingActionId: '2' } }}>
          購入後ステップ配信
        </Link>
      ),
      content: <MarketingAction />,
    },
    {
      value: '3',
      label: (
        <Link href={{ pathname, query: { ...query, marketingActionId: '3' } }}>
          レコメンド診断ボット（静的）
        </Link>
      ),
      content: <MarketingAction />,
